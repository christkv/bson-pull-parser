...
Object.defineProperty(Parser.prototype, 'eventType', {
  get: function() { return this.s.eventType; }
});

Object.defineProperty(Parser.prototype, 'parent', {
  get: function() { return this.s.parent; }
});
...
Object.defineProperty(Parser.prototype, 'value', {
  get: function() { return this.s.value; }
});
...
Parser.prototype.next = function() {
  ...
  if(this.s.eventType == Parser.START_DOCUMENT) {
    ...
    if(elementType == BSON_DATA_STRING) {
      ...
      var stringSize = buffer.readInt32LE(this.s.index + 4);
      this.s.index += 8;
