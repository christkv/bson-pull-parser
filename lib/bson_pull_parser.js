...
Parser.prototype.parent = function() {
...
Parser.prototype.next = function() {
  ...
  if(this.s.eventType == Parser.START_DOCUMENT) {
    ...
    // } else if(this.s.eventType == Parser.START_CODE_W_SCOPE_OBJECT) {
    //   console.log("------------------------ next START_CODE_W_SCOPE_OBJECT")
    // } else {
    ...
    if(elementType == BSON_DATA_STRING) {
      ...
      // console.log("------------------------ next BSON_DATA_CODE_W_SCOPE")
